<template>
  <div class="loadmore">
    ...
    >
      ...
      <slot></slot>
      <slot name="bottom">
        <div class="loadmore-hint loadmore-hint-bottom" v-if="bottomMethod && !bottomAllLoaded">
  ...
  methods: {
    getScrollElement (element) {
      ...
      while (
        ...
        overflowY = document.defaultView.getComputedStyle(currentNode)
          .overflowY
    ...
    handleTouchMove (event) {
      ...
      if (
        ...
        event.stopPropagation()
        this.translate =
          this.getScrollTop(this.scrollElement) -
          this.startScrollTop +
          distance
        if (this.translate > 0) this.translate = 0
        this.bottomStatus =
